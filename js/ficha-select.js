/**
 * ficha-select.js — Dropdown customizado com busca + filtros v5.0
...
const FichaSelect = {
  ...
  _data: [], _query: '', _isOpen: false, _focused: -1,
  _filterEspulaId: '', _filterTipoFioId: '',
  _mobileOverlay: null,
  onChange: null,
  // Filtros externos aplicados antes de renderizar a lista
  _filterEspulaId:  '',
  _filterTipoFioId: '',
